<template>
    <section class="charts-difference">
      <h5 class="charts-difference__title">{{ $t('charts_difference.title') }}</h5>
      <div class="charts-difference__imgs">
        <div class="charts-difference__imgs_left">
          <img class="charts-difference__imgs_img" src="../assets/img/image_potatoes.png" alt="Potatoes" />
          <h6 class="charts-difference__imgs_title">{{ $t('charts_difference.potatoes_title') }}</h6>
          <img class="charts-difference__imgs_chart" :src="potatoesChartSrc" alt="chart potatoes" />
        </div>
        <div class="chart-difference__imgs_right">
          <div class="charts-difference__imgs_left">
            <img class="charts-difference__imgs_img" src="../assets/img/image_peaches.png" alt="peaches" />
            <h6 class="charts-difference__imgs_title">{{ $t('charts_difference.peaches_title') }}</h6>
            <img class="charts-difference__imgs_chart" :src="peachesChartSrc" alt="chart peaches" />
          </div>
        </div>
      </div>
